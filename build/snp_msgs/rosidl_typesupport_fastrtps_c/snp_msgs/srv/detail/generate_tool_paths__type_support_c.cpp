...
#include "rosidl_runtime_c/string.h"  // mesh_filename
#include "rosidl_runtime_c/string_functions.h"  // mesh_filename
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: min_hole_size
  {
    cdr << ros_message->min_hole_size;
  }

  // Field name: min_segment_length
  {
    cdr << ros_message->min_segment_length;
  }

  // Field name: point_spacing
  {
    cdr << ros_message->point_spacing;
  }

  // Field name: search_radius
  {
...
{
  return max_serialized_size_snp_msgs__srv__GenerateToolPaths_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_snp_msgs__srv__GenerateToolPaths_Response(
    full_bounded, 0);
}
