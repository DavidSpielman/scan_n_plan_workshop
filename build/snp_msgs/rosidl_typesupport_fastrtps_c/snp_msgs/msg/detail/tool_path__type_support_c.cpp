...
#include "snp_msgs/msg/detail/tool_path__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/pose_array__functions.h"  // segments
...
using _ToolPath__ros_msg_type = snp_msgs__msg__ToolPath;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ToolPath__ros_msg_type * ros_message = static_cast<const _ToolPath__ros_msg_type *>(untyped_ros_message);
  // Field name: segments
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ToolPath__ros_msg_type * ros_message = static_cast<_ToolPath__ros_msg_type *>(untyped_ros_message);
  // Field name: segments
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
    ...
    if (ros_message->segments.data) {
      geometry_msgs__msg__PoseArray__Sequence__fini(&ros_message->segments);
    }
...
static uint32_t _ToolPath__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_snp_msgs__msg__ToolPath(
...
static size_t _ToolPath__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_snp_msgs__msg__ToolPath(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ToolPath = {
  "snp_msgs::msg",
  "ToolPath",
