...
static const _ExecuteMotionPlan_Request_type_support_symbol_names_t _ExecuteMotionPlan_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, snp_msgs, srv, ExecuteMotionPlan_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, snp_msgs, srv, ExecuteMotionPlan_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, snp_msgs, srv, ExecuteMotionPlan_Request)() {
  return &::snp_msgs::srv::rosidl_typesupport_c::ExecuteMotionPlan_Request_message_type_support_handle;
}
...
static const _ExecuteMotionPlan_Response_type_support_symbol_names_t _ExecuteMotionPlan_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, snp_msgs, srv, ExecuteMotionPlan_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, snp_msgs, srv, ExecuteMotionPlan_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_snp_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, snp_msgs, srv, ExecuteMotionPlan_Response)() {
  return &::snp_msgs::srv::rosidl_typesupport_c::ExecuteMotionPlan_Response_message_type_support_handle;
}
...
static const _ExecuteMotionPlan_type_support_symbol_names_t _ExecuteMotionPlan_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, snp_msgs, srv, ExecuteMotionPlan)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, snp_msgs, srv, ExecuteMotionPlan)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, snp_msgs, srv, ExecuteMotionPlan)() {
  return &::snp_msgs::srv::rosidl_typesupport_c::ExecuteMotionPlan_service_type_support_handle;
}
