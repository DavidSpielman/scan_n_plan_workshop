...
static size_t _ExecuteMotionPlan_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ExecuteMotionPlan_Request(full_bounded, 0);
}
...
static size_t _ExecuteMotionPlan_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ExecuteMotionPlan_Response(full_bounded, 0);
}
