...
#ifndef SNP_MSGS__SRV__DETAIL__GENERATE_MOTION_PLAN__FUNCTIONS_H_
#define SNP_MSGS__SRV__DETAIL__GENERATE_MOTION_PLAN__FUNCTIONS_H_
...
/// Initialize srv/GenerateMotionPlan message.
/**
...
/// Finalize srv/GenerateMotionPlan message.
/**
...
/// Create srv/GenerateMotionPlan message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * snp_msgs__srv__GenerateMotionPlan_Request__init().
...
/// Destroy srv/GenerateMotionPlan message.
/**
 * It calls
 * snp_msgs__srv__GenerateMotionPlan_Request__fini()
...
/// Initialize array of srv/GenerateMotionPlan messages.
/**
...
/// Finalize array of srv/GenerateMotionPlan messages.
/**
 * It calls
 * snp_msgs__srv__GenerateMotionPlan_Request__fini()
...
/// Create array of srv/GenerateMotionPlan messages.
/**
 * It allocates the memory for the array and calls
 * snp_msgs__srv__GenerateMotionPlan_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GenerateMotionPlan messages.
/**
 * It calls
 * snp_msgs__srv__GenerateMotionPlan_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * snp_msgs__srv__GenerateMotionPlan_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_snp_msgs
...
/**
 * It calls
 * snp_msgs__srv__GenerateMotionPlan_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_snp_msgs
...
/**
 * It allocates the memory for the array and calls
 * snp_msgs__srv__GenerateMotionPlan_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_snp_msgs
...
/**
 * It calls
 * snp_msgs__srv__GenerateMotionPlan_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SNP_MSGS__SRV__DETAIL__GENERATE_MOTION_PLAN__FUNCTIONS_H_
